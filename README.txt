...
= 2.0.4 =
*   Bugfix added missing arg to `get_wpd_product_details` REST API details in `admin/class-wpd-gear-rest-api.php`
*   Updated image sizes to use WPD built-in helper function in `admin/class-wpd-gear-widgets.php`
